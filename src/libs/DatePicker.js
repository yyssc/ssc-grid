/* eslint react/no-multi-comp: 0, no-nested-ternary: 0, babel/object-shorthand: 0 */
// Copy from https://github.com/pushtell/react-bootstrap-date-picker/blob/master/src/index.jsx
  ...
  handleInputChange() {
    ...
    if (this.props.dateFormat.match(/MM.DD.YYYY/)) {
      if (!inputValue.match(/[0-1][0-9].[0-3][0-9].[1-2][0-9][0-9][0-9]/)) {
        this.handleBadInput(originalValue);
      }
